...
snn = SimpleRNN(units=32, activation='relu', input_shape=(3, 1))(input1)
dense1 = Dense(64, activation='relu')(snn)
...
snn = SimpleRNN(units=33, activation='relu', input_shape=(3, 1))(input2)
dense11 = Dense(10, activation='relu')(snn)
