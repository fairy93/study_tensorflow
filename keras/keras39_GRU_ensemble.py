...
gru = GRU(units=32, activation='relu', input_shape=(3, 1))(input1)
...
gru = GRU(units=33, activation='relu', input_shape=(3, 1))(input2)
dense11 = Dense(10, activation='relu')(gru)
