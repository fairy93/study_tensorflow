...
# 최적의 매개변수 :  Pipeline(steps=[('scaler', MinMaxScaler()), ('rf', RandomForestRegressor())])
# best_params_ :  {'rf__n_estimators': 100}
# best_score :  0.8517510362784707
# model.scored :  0.8954600531253445
# r2_score :  0.8954600531253445
# 걸린시간 :  18.765758275985718